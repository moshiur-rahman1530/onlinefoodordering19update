...
@endif
                    ...
                    <table class="table table-hover table-striped table-responsive" border="1" cellpadding="3" id="dataTable">
                          ...
                          @foreach ($orders as $order)
                              ...
                              <tr>
                               ...
                               <button type="button" class="btn btn-warning btn-sm">Not completed</button>
                                  ...
                                  <td>
                                  <a href="{{route('admin.order.show',$order->id)}}" class="btn btn-info">
                                  <i class="fa fa-info"style="color:black;"></i>View Order</a>
                       ...
                       @endforeach
                        ...
                        <tr>
                            ...
                            <th>Orderer phone No</th>
                           <th>Orderer Status</th>
                            <th>  <a href="#deleteModal{{$order->id}}" data-toggle="modal"class="btn btn-danger">
                                  <i class="fa fa-trash"style="color:black;"></i>Delete All</a>
                          ...
                          <span aria-hidden="true">&times;</span>
                            ...
                            <div class="modal-body">
                                <form action="{{route('admin.order.deleteall')}}" method="post">
                                {{csrf_field()}}
                                <button type="submit" class="btn btn-danger"><i class="fa fa-trash"style="color:black;"></i>Yes,Delete</button>
                                <button type="button" class="btn btn-success" data-dismiss="modal"><i class="fa fa-close"style="color:black;"></i>No,Cancel</button>
                                </form>
